...
public class FaixaPlaylistService {

	private static FaixaPlaylistService instance;
	private DAOFactory factory = new PostgresDAOFactory();

	public static FaixaPlaylistService getInstance() {
		if (instance == null) {
			instance = new FaixaPlaylistService();
		}
		return instance;
	}
	...
	public List<Faixa> getFaixas(int id) {
		...
		try {
			this.faixas = dao.buscaFaixaPorIdPlaylist(id);
